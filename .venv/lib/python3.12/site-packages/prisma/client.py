...
SCHEMA_PATH = Path('/opt/pgvector/litellm-pgvector/prisma/schema.prisma')
...
class Prisma:
    vectorstore: 'actions.VectorStoreActions[models.VectorStore]'
    ...
    def __init__(
        ...
        *,
        ...
        self.vectorstore = actions.VectorStoreActions[models.VectorStore](self, models.VectorStore)
...
class Batch:
    vectorstore: 'VectorStoreBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.vectorstore = VectorStoreBatchActions(self)
